...
using TMPro;
public class MainMenuTestScript
{
    ...
    public void StartButton_AddsOnlySelectedPlayersToGameSettings()
    {
        ...
        Assert.AreEqual(1, GameSettings.settingsList[0].selectedType); // AI
        Assert.AreEqual(2, GameSettings.settingsList[0].selectedColor); // Red
